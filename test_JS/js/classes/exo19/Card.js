...
export default class Card extends CoopDom {
    ...
    handleEvents = () => {
        ...
        // Afficher ou cacher la réponse au clic sur la question
        this.domElements.question.onclick = () => {
             this.domElements.answer.hidden == true ? this.domElements.answer.hidden = false : this.domElements.answer.hidden = true; 
        }  
    }
    render = () => {
